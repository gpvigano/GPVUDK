...
namespace GPVUDK
{
    ...
    /// This script allows GPVUDK-WSUI to interact cleanly with Unity Canvases.
    ...
    /// Note: Not intended for direct use. GPVUDK-WSUI will intelligently replace the default GraphicsRaycaster
    ///   on canvases with this raycaster.

    public class UIWorldGraphicRaycaster : GraphicRaycaster
    {
