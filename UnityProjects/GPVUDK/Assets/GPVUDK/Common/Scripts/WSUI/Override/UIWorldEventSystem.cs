...
namespace GPVUDK
{
    ...
    public class UIWorldEventSystem : EventSystem
    {
        protected EventSystem previousEventSystem;
        protected UIWorldPointerInputModule vrInputModule;
        ...
        protected override void OnEnable()
        {
            ...
            vrInputModule = gameObject.AddComponent<UIWorldPointerInputModule>();
            base.OnEnable();
