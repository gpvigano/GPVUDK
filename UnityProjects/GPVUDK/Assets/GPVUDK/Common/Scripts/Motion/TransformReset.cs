...
{
    /// <summary>
    /// Reset a set of transforms on demand.
    /// </summary>
    public class TransformReset : MonoBehaviour
    {
        /// <summary>
        /// Transforms to be reset.
        /// </summary>
        [Tooltip("Transforms to be reset")]
        public Transform[] toReset;
		
        /// <summary>
        /// Reference transform (optional): other transforms will be reset relative to its position/rotation.
        /// </summary>
        ...
        /// <summary>
        /// If Reference Transform is set use its heading to reorientate the target transforms.
        /// </summary>
		...
		/// <summary>
        /// Reset the configured transforms.
        /// </summary>
